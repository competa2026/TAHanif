...
class VRPEnvironment:
    def __init__(self, file_path, num_customers=75):
...
# ==============================================================================
# BLOK EKSEKUSI FINAL: UJI STABILITAS SKALA PENUH (75 PELANGGAN)
# ==============================================================================
if __name__ == "__main__":
    ...
    if len(hasil_stabilitas) > 0:
        ...
        # Simpan ke CSV
        nama_file = "FinalRun_HybridACO_2Opt_75Cust_10Reps.csv"
